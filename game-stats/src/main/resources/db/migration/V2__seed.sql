...
INSERT INTO Operador (Nome, Velocidade, Blindagem, Unidade_Especial, Funcao) VALUES
    ('Twitch', 2, 2, 'GIGN', 'Ataque'),
    ('Doc', 1, 3, 'GIGN', 'Defesa'),
    ('Blackbeard', 2, 2, 'Navy SEALs', 'Ataque'),
    ('Rook', 1, 3, 'GIGN', 'Defesa'),
    ('Ash', 3, 1, 'FBI SWAT', 'Ataque'),
    ('Azami', 2, 2, 'SAT', 'Defesa'),
    ('Bandit', 3, 1, 'GSG 9', 'Defesa'),
    ('Mute', 2, 2, 'SAS', 'Defesa'),
    ('Valkyrie', 2, 2, 'Navy SEALs', 'Defesa'),
    ('Buck', 2, 2, 'JTF2', 'Ataque'),
    ('Frost', 2, 2, 'JTF2', 'Defesa'),
    ('Finka', 2, 2, 'Spetsnaz', 'Ataque'),
    ('Lion', 2, 2, 'GIGN', 'Ataque'),
    ('Ace', 2, 2, 'NIGHTHAVEN', 'Ataque'),
    ('Zofia', 2, 2, 'GROM', 'Ataque'),
    ('Jäger', 3, 1, 'GSG 9', 'Defesa'),
    ('Lesion', 2, 2, 'SDU', 'Defesa'),
    ('Caveira', 3, 1, 'BOPE', 'Defesa'),
    ('Nomad', 2, 2, 'GIGR', 'Ataque'),
    ('Aruni', 2, 2, 'NIGHTHAVEN', 'Defesa'),
    ('Iana', 2, 2, 'REU', 'Ataque'),
    ('Thorn', 2, 2, 'NIGHTHAVEN', 'Defesa'),
    ('Flores', 2, 2, 'N/A', 'Ataque'),
    ('Kapkan', 2, 2, 'Spetsnaz', 'Defesa'),
    ('Solis', 2, 2, 'N/A', 'Defesa'),
    ('Melusi', 3, 1, 'N/A', 'Defesa'),
    ('Maverick', 3, 1, 'N/A', 'Ataque'),
    ('Capitão', 3, 1, 'BOPE', 'Ataque'),
    ('Mozzie', 2, 2, 'SASR', 'Defesa'),
    ('Pulse', 3, 1, 'FBI SWAT', 'Defesa'),
    ('Hibana', 3, 1, 'SAT', 'Ataque'),
    ('Sledge', 2, 2, 'SAS', 'Ataque');
