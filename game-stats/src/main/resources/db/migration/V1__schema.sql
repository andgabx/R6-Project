...
-- Possui (Jogador - Operador)
CREATE TABLE Possui (
    fk_Jogador_ID_Jogador INT NOT NULL,
    fk_Operador_ID_Operador INT NOT NULL,
    PRIMARY KEY (fk_Jogador_ID_Jogador, fk_Operador_ID_Operador),
    CONSTRAINT FK_Possui_Jogador FOREIGN KEY (fk_Jogador_ID_Jogador) REFERENCES Jogador(ID_Jogador) ON DELETE CASCADE,
    CONSTRAINT FK_Possui_Operador FOREIGN KEY (fk_Operador_ID_Operador) REFERENCES Operador(ID_Operador) ON DELETE CASCADE
);
